  ...
  <footer class="text-center text-lg-start bg-light text-muted">
    ...
    <section class="container d-flex justify-content-center justify-content-lg-between border-bottom px-3">
      <!-- Left -->
    ...
    <div class="text-center p-1" style="background-color: rgba(0, 0, 0, 0.05);">
      © 2023 Copyright:
      <a class="text-reset fw-bold" href="https://portfolio.sazonmahmud.net">LWSAZON</a>
    </div>
    <!-- Copyright -->
  </footer>
